...
function StarsLayer({ count }: { count: number }) {
...
export default function SaptaarTimelines() {
  return (
    <section className="relative bg-black py-20 px-6 sm:px-10 lg:px-12 text-center">
      {/* Background Lines */}
      <div className="oj-bg-lines">
        {[...Array(18)].map((_, i) => (
          <div
            key={i}
            className="oj-line"
